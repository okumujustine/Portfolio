...
export default function Card({ link, videoLink, description, projectTitle, myTitle, imageLink }) {
  return (
    <div className="shadow-sm border-2 border-gray-100 py-6 px-3 flex flex-col mt-4">
      <div>
        ...
        {imageLink && <div style={{ width: "100% !important", height: "200px", backgroundImage: `url('${imageLink}')`, backgroundSize: "contain" }}></div>}
      </div>
      <hr />
